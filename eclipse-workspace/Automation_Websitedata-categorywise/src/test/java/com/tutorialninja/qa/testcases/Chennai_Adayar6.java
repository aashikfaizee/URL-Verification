...
public class Chennai_Adayar6 {
...

	{
		...
		for (WebElement option : options) {
			...
			if (option.getText().equals("Ramanathapuram")) {

				dropdown1.selectByVisibleText("Ramanathapuram");
	...
	public static void sub_register() throws InterruptedException, IOException {
		...
		for (WebElement option1 : options1) {
			...
			if (option1.getText().equals("Karaikudi Joint II")) {

				dropdown2.selectByVisibleText("Karaikudi Joint II");
	...
	public static void verifyAdayar_Registeration() throws InterruptedException, IOException {
		...
		try (FileOutputStream fileOut = new FileOutputStream("trial.xlsx")) {
