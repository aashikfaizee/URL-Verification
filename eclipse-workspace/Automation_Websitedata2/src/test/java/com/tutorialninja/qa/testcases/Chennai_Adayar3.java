...
public class Chennai_Adayar3 {
	...
	@Test(priority = 1)
	public void verifyAdayar_Registeration() throws InterruptedException {
		...
		Select dropdown3 = new Select(Reg_Village);
			...
			// Print the selected option text (optional)
			String selectedOptionText = dropdown3.getFirstSelectedOption().getText();
